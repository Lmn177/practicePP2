...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        # Масштабируем твою картинку 360x360 до 35x35
...
while True:
    ...
    best_text = font_small.render(f"Best: {HIGH_SCORE}", True, BLACK)
    DISPLAYSURF.blit(scores, (10,10))
    DISPLAYSURF.blit(coin_text, (SCREEN_WIDTH-110, 10))
    DISPLAYSURF.blit(best_text, (SCREEN_WIDTH-110, 30))
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        if SCORE > HIGH_SCORE: save_highscore(SCORE)

...
def main():
    ...
    clock_radius = 220
    # Загружаем картинку
    # bg_image = pygame.image.load(os.path.join(images_dir, "mickeyclock.jpeg")).convert_alpha()
    # Подгоняем размер картинки под размер наших часов (диаметр 440)
    # bg_image = pygame.transform.smoothscale(bg_image, (440, 440))
    running = True
    ...
    while running:
        ...
        #----face_rect = bg_image.get_rect(center=CENTER)
        #----screen.blit(bg_image, face_rect)
